...
# As a way to double check, run in ${$}:
...
#       cpanm --installdeps --notest .
        ...
        # No ebuild for module Cwd
        #   It's part of perl core

        # No ebuild for module Digest::HMAC_SHA1
        #   It's part of dev-perl/Digest-HMAC

        # g-cpan wants to build Email-MIME for this instead
        #perl-gcpan/Email-MIME-Creator

        # No ebuild for Sys::Hostname
        #   It's part of perl-core

        # g-cpan wants to build RSS-Parser-Lite for this instead
...
"
        ...
        # There is no ebuild for Locale::Messages
MAKEFILE_I18N="
        dev-perl/Locale-PO
"
...
pkg_setup() {
        ...
        enewgroup musicbrainz
        # Create musicbrainz user, put in musicbrainz group
        enewuser mb -1 -1 -1 musicbrainz
}
...
pkg_postinst {
    ...
    elog "A full description of these steps can be found here:"
        ...
        elog
        elog "Please configure /etc/conf.d/${PN} before starting the server."
        elog
